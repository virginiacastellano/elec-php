...
$employeess = getemployeessWithAttendanceCount($start, $end);
...
foreach ($employeess as $employees) {
    $hoja->setCellValueByColumnAndRow(1, $y, $employees->name);
    $hoja->setCellValueByColumnAndRow(2, $y, $employees->presence_count);
    $hoja->setCellValueByColumnAndRow(3, $y, $employees->absence_count);
    $y++;
}
